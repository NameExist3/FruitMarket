...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`market` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
...
insert  into `comment`(`id`,`user_id`,`item_id`,`content`,`addTime`) values (7,3,35,'真的很不错','2020-04-02 19:23:03'),(8,3,28,'真好吃','2020-04-03 19:32:31');
...
insert  into `item_category`(`id`,`name`,`pid`,`isDelete`) values (50,' 礼帽',44,1),(69,'梨子',NULL,0),(70,'湾里酥梨',69,0),(71,'石榴',NULL,0),(72,'肖山御石榴',71,0),(73,'桃子',NULL,0),(74,'史德镇御桃',73,0),(75,'苹果',NULL,0),(76,'日本红富士',75,0),(77,'秦冠',75,0),(78,'嘎拉',75,1),(79,'黄元帅',75,0),(80,'菠菜',NULL,0),(81,'xx',75,0);
...
insert  into `item_order`(`id`,`item_id`,`user_id`,`code`,`addTime`,`total`,`isDelete`,`status`) values (27,NULL,3,'2020032017080001','2020-03-20 17:08:56','54.9',0,3),(28,NULL,3,'2020032017380001','2020-03-20 17:38:52','653.59',0,3),(29,NULL,3,'2020032017390001','2020-03-20 17:39:28','976.5',0,3),(30,NULL,3,'2020032019220001','2020-03-20 19:22:25','364.5',0,3),(31,NULL,3,'2020032019310001','2020-03-20 19:31:23','359.15999999999997',0,1),(32,NULL,3,'2020032019310002','2020-03-20 19:31:50','59.86',0,3),(33,NULL,1,'2020092009290001','2020-06-20 09:29:40','60.00',0,1);
...
insert  into `order_detail`(`id`,`item_id`,`order_id`,`status`,`num`,`total`) values (54,27,27,0,1,'1'),(55,32,28,0,5,'25'),(56,27,28,0,3,'9'),(57,28,28,0,1,'1'),(58,35,29,0,2,'4'),(59,34,29,0,4,'16'),(60,32,29,0,3,'9'),(61,36,29,0,3,'9'),(62,32,29,0,2,'4'),(63,35,30,0,6,'36'),(64,30,30,0,3,'9'),(65,28,31,0,4,'16'),(66,28,31,0,2,'4'),(67,28,32,0,1,'1'),(68,36,33,0,1,'60.0');
...
insert  into `sc`(`id`,`item_id`,`user_id`) values (17,27,3),(18,28,3);
...
insert  into `user`(`id`,`userName`,`passWord`,`phone`,`realName`,`sex`,`address`,`email`) values (1,'1','2','3','4','1','3','22'),(2,'dd','dd','dd',NULL,NULL,NULL,NULL),(3,'zs','111111','12345678933','测试33','女','这里是','1133'),(6,'huang1','123456','18888888',NULL,NULL,NULL,NULL),(7,'huang1','123456','18888888',NULL,NULL,NULL,NULL),(8,'1111112','11','11',NULL,NULL,NULL,'111@qq.com');
